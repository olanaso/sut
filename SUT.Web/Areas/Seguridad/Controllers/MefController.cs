...
namespace Sut.Web.Areas.Seguridad.Controllers
{
    ...
    public class MefController : Controller
    {
        ...
        private readonly ILogService<MefController> _log;
